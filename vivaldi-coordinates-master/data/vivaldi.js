...
input: a matrix with missing values in 2 files: argv[2] + argv[4]
output: a completed matrix in a file: argv[5]
...
const iterations = Number(process.argv[3]) || 1; // the max number of iterations
